// Main script file
// Curtain image navigation, imprint toggle
...
function initCurtain(images) {
  ...
  // itself is fixed. There's a second column shown only on very wide
  // screens (see .curtain-column[data-column="right"] in style.css).
