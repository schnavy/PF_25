...
function initCurtain(images) {
  ...
  // still decode it lazily once assigned to the visible <img>, which is what
  // caused a brief flash of the outgoing image on click. decode() forces
  // that work to happen ahead of time, off-screen.
